...
###
### Set up custom rsync command
###

RSYNC_COMMAND_DIR="$( create_tmp_dir )"
create_link "${RSYNC_COMMAND_DIR}" "custom_rsync" "$(command -v rsync 2>/dev/null)"
export RSYNC_COMMAND="${RSYNC_COMMAND_DIR}/custom_rsync"
